export default function AllianceSaltLanding() {
  const products = [
    {
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div>
            ...
            <div className="text-sm text-slate-500">Поставки соли для бизнеса и частных клиентов</div>
          </div>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 md:items-center md:py-24 lg:px-8">
            <div className="relative z-10">
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
                Современный сайт-каталог с понятной навигацией, быстрым доступом к ассортименту,
                заявкой в один клик и акцентом на доверие клиента.
              </p>
        ...
        <section id="catalog" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <div className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Ассортимент</div>
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Основные категории продукции</h2>
            </div>
            <p className="max-w-2xl text-slate-600">
              Каталог должен открываться быстро и сразу показывать клиенту понятные группы товаров,
              чтобы он за 10–15 секунд понимал, что здесь можно заказать.
            </p>
          </div>
        ...
        <section id="advantages" className="bg-slate-50 py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div>
                <div className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Почему мы</div>
                <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                  Сайт должен не просто выглядеть красиво, а помогать продавать
                </h2>
                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
                  Главная задача — не перегрузить клиента лишними эффектами. Нужны доверие, скорость,
                  чёткая структура и лёгкий путь от первого экрана до заявки.
                </p>
              </div>
